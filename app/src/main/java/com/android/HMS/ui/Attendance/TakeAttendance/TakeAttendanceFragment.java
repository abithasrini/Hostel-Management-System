...
import com.android.HMS.databinding.FragmentTakeAttendanceBinding;
...
public class TakeAttendanceFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TakeAttendanceViewModel takeAttendanceViewModel = new ViewModelProvider(this).get(TakeAttendanceViewModel.class);

        binding = com.android.HMS.databinding.FragmentTakeAttendanceBinding.inflate(inflater, container, false);
        ...
        final TextView textView = binding.textTakeAttendance;
        takeAttendanceViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);

        final AutoCompleteTextView dateInputEditText=binding.date;
        takeAttendanceViewModel.getDate().observe(getViewLifecycleOwner(), dateInputEditText::setText);
        ...
        Button buttonTakeAttendance= binding.buttonTakeAttendance;
        ...
        buttonTakeAttendance.setOnClickListener(v -> {
            if (buttonTakeAttendanceEnabled(blockLayout,floorLayout,srnLayout,ernLayout)){
                ...
                if(srn>ern){
                    ...
                    floor=floorSpinner.getText().toString();
                    ...
                    intent.putExtra("Mode","Take Attendance");
